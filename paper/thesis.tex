...
An early method for sound sequence alignment in the literature is the one proposed by \citet{1996_Covington},
...
This function assigns hand-crafted values depending entirely on whether the segments are consonants, vowels, or glides.
...
\citet{2013_Jäger} uses the ASJP database to calculate the Partial Mutual Information (PMI) scores between each pair of ASJP segments.


\section{Other methods}


\section{Phoneme vectorisation}
