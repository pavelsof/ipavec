...
In order to quantify the methods' performance, we employ a simple evaluation scheme which is also used in \citet{2002_Kondrak_Hirst}:
each correct alignment yields 1 point;
if n alternative alignments are produced for a particular pair and the correct one is among these the score is 1/n points;
